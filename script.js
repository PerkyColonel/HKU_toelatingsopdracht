...
class CharacterPointer extends Entity {
    constructor({ game, html, data, cursor, owner }) {
        super({ game, html, data });
        this.cursor = cursor;
        this.owner = owner;
            ...
            () => {
                ...
                new Effect({
                    ...
                    data: {
                        ...
                        size: { x: 1, y: 1 },
                        position: {
                            x: 22 * Math.cos(rad) + this.owner.position.x + 7.5 + Game.random(-3, 3),
                            y: 22 * Math.sin(rad) + this.owner.position.y + 7.5 + Game.random(-3, 3),
                        },
                    },
                    html: {
                        classList: ["effect"],
...
//         [24, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25],
//         [24, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25],
//         [24, 11, 11, 11, 11, 11, 25, 11, 11, 11, 11, 25],
//         [24, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25],
//         [24, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25],
//         [24, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25],
//         [24, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 25],
